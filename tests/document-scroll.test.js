...
static MenuLayer *s_document_view=(void*)1;static void *s_document_scroll=(void*)1;static int s_rich_count=5,s_rich_active=-1,s_rich_scroll,s_rich_offset,s_rich_total=40,s_rich_restore,s_image_index=-1,s_request,s_theme_size=22;
static bool s_loading,s_image_loading,s_rich_animate,animated_last;static char s_image_error[96];static char s_current_id[65];static int command,page,images;static GPoint offset;
...
static void scroll_layer_set_content_offset(void*l,GPoint p,bool animated){offset=p;animated_last=animated;}
...
int main(void){
 ...
 rich_move(true);assert(s_rich_scroll==16&&offset.y==-16&&s_rich_active==-1&&animated_last&&!s_rich_animate);
