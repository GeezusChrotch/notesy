...
Status: prepared locally; repository, release and store listing are not yet published.
...
- Price: Free
- License: MIT (third-party notices included)
- Source: https://github.com/GeezusChrotch/notesy
- Website: https://geezuschrotch.github.io/notesy/
- Support: https://github.com/GeezusChrotch/notesy/issues
- Large icon: `appstore-assets/notesy-icon-large.png` (144 × 144)
- Small icon: `appstore-assets/notesy-icon-small.png` (80 × 80)
- Launcher: `resources/images/notesy-menu-icon.png` (25 × 25)

## Description

Your Obsidian vault, on your wrist.

Notesy brings quick capture and useful everyday notes to Pebble Time and Time 2. Dictate a new note, append a thought to the note you're reading, or speak a search term to find likely matches across your vault.
