...
sys.argv=['pebble','install','build/Notesy-fixture.pbw','--emulator',os.environ.get('WATCH_TEST_PLATFORM','emery')]
result=run_tool()
...
if env.get('WATCH_TEST_LONG_LOG') or env.get('WATCH_TEST_FORMATTING'):env.pop('WATCH_TEST_LINKS_ONLY',None)
