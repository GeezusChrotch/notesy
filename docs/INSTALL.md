...
1. Install **Organik Apps Pebble Connector 0.7.0 or later** from its
   [release page](https://github.com/GeezusChrotch/organik-pebble-connector/releases/tag/v0.7.0).
...
1. Open `Notesy-1.4.4.pbw` from the [Notesy release](https://github.com/GeezusChrotch/notesy/releases/tag/v1.4.4)
