...
function normalize(value){return defaults.map(function(fallback,i){var n=value&&value[i];return typeof n==='number'&&n>=0&&n<=7&&n%1===0?n:fallback;});}
function setup(saved){
  var names=['Up press','Select press','Down press','Up long press','Select long press','Down long press'];
  var actions=['Normal navigation','New note','Append to note','Delete note','Pin / unpin','Actions menu','No action','Refresh'];
