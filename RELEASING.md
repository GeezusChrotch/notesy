...
Notesy 1.4.7 is the public beta. See docs/RELEASE_STATUS.md for verified publication
...
2. Verify `dist/Notesy-1.4.7.pbw`, source archive, store assets and `SHA256SUMS`.
...
4. Publish Notesy's `v1.4.7` release with PBW, source archive, store asset archive, checksums and
   the text from `docs/RELEASE_NOTES_1.4.7.md`.
