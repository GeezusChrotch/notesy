...
Notesy 1.4.6 is the public beta. See docs/RELEASE_STATUS.md for verified publication
...
The separate connector task owns its 0.8.0 implementation, signing, notarization, Sparkle feed
...
2. Verify `dist/Notesy-1.4.6.pbw`, source archive, store assets and `SHA256SUMS`.
...
4. Publish Notesy's `v1.4.6` release with PBW, source archive, store asset archive, checksums and
   the text from `docs/RELEASE_NOTES_1.4.6.md`.
