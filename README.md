...
Notesy 1.0.1 is prepared for its first public release alongside
...
[download the 1.0.1 public beta](https://github.com/GeezusChrotch/notesy/releases/tag/v1.0.1).
See [release status](docs/RELEASE_STATUS.md) for validation details.

Browse an Obsidian vault, read notes and capture dictation on Pebble Time and Time 2. Version 1.0.1 · public beta.
...
Pebble → Notesy → Settings, test, and save. Install `dist/Notesy-1.0.1.pbw` on the watch.
...
Use `build/StoneNotes.pbw` for debugging and `dist/Notesy-1.0.1.pbw` for distribution; the latter
...
service. Normal watch installations must use `dist/Notesy-1.0.1.pbw`.
